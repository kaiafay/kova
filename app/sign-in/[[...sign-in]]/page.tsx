...
import { SignIn, useOrganizationList, useUser } from "@clerk/nextjs";
      ...
      >
        ...
        >
          <svg width="28" height="28" viewBox="0 0 48 48" fill="none">
            <polygon
              points="24,4 36,16 24,22 12,16"
              fill="#2563eb"
              opacity="0.9"
            />
            <polygon
              points="24,22 36,16 38,32 24,44"
              fill="#1d4ed8"
              opacity="0.75"
            />
            <polygon
              points="24,22 12,16 10,32 24,44"
              fill="#3b82f6"
              opacity="0.85"
            />
        ...
        <div style={{ fontSize: 14, color: C.muted, marginBottom: 28 }}>
          Set up your shared budget to get started.
        </div>
        ...
        <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>
          ...
          <div style={{ fontSize: 13.5, color: C.muted, lineHeight: 1.6 }}>
            Ask a member to invite you from their budget switcher inside Kova.
            Once they send an invite, accept it from your email and you&apos;ll
