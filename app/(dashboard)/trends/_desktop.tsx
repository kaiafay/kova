...
export default function DesktopTrends() {
  ...
  const avgs = useMemo(() => {
    ...
    const debt = chartData.reduce((s, d) => s + d["Debt Paid"], 0) / n;
          ...
          {months.length === 0 ? (
            <>
              ...
              <div style={{ fontSize: 13.5 }}>
                Add transactions to get started. Trends appear once you have 2+
                months of data.
              </div>
            </>
          ) : (
            <>
              ...
              <div style={{ fontSize: 13.5 }}>
                You have 1 month recorded — add transactions for another month
                to unlock trends.
              </div>
            </>
          )}
        ...
        <>
          ...
          <div style={card}>
            ...
            <ResponsiveContainer width="100%" height={320}>
              ...
              >
                ...
                <Legend
                  wrapperStyle={{ fontSize: 13, color: C.muted, paddingTop: 8 }}
                />
                <Line
                  type="monotone"
                  dataKey="Income"
          ...
          <div style={{ ...card, marginTop: 16, overflowX: "auto" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  {["Month", "Income", "Money Out", "Net", "Debt Paid"].map(
                    (h) => (
                      <th
                        key={h}
                        style={{
